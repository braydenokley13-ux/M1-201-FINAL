...
## Completed TODO IDs
- ~~`WORLD-004`~~: HUD/teacher messaging for automatic quality changes. **DONE**
- ~~`UI-001`~~: Keyboard-only modal focus trap with Tab/Shift+Tab cycling, Escape close, focus restoration. **DONE**
